...
int main(void) {
  ...
  std::cout << BLUE << "\n---> Pointer to data structure:" << RESET
            << std::endl;
  ...
  std::cout << BLUE << "\n---> serialized uintptr_t of data structire:" << RESET
            << std::endl;
  ...
  std::cout << BLUE << "\n---> deserialized Data* of data structire:" << RESET
            << std::endl;
  ...
  std::cout << "\noriginal (" << &data << ") == deserialized ("
            << deserialized_ptr << "):" << std::endl;
  std::cout << "\t- result: "
            << ((&data == deserialized_ptr) ? MAGENTA "TRUE" : RED "FALSE")
            << RESET << std::endl;

  std::cout << BLUE << "\n---> Fields of deserialized data structure:" << RESET
            << std::endl;
